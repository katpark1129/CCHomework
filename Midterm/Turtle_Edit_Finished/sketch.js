...
var step = 32; // how much the turtle moves with each 'F'
var angle = 90; // how much the turtle turns with a '-' or '+'
var crickets; 
// LINDENMAYER STUFF (L-SYSTEMS)
var thestring = 'A'; // "axiom" or start of the string
var numloops = 2; // how many iterations of the L-system to pre-compute
var therules = []; // array for rules
therules[0] = ['A', 'ffjdfjdjdjfjdjfdddffjdfjdjdjfjdjfdddffkjdfjdjdjfjdjfdfffjdfjdjdjfjdjfdffffjdfjdjdjfjdjfffdffjdfjdjdjfjdjf']; // first rule
therules[1] = ['B', 'fjdffjdfjdjdjfjdjfdddfdjj']; // second rule
...
function setup()
{
  ...
  stroke(255,0,0,255); // draw in black
